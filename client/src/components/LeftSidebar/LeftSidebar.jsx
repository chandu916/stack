...
const LeftSidebar = ({ slideIn = true, onClose = () => {} }) => {
  const closeOnMobile = () => {
    if (window.innerWidth <= 760) onClose();
  };

  return (
    <div className={`left-sidebar ${slideIn ? 'open' : 'closed'}`}>
        <nav className='side-nav'>
            <NavLink to='/' className='side-nav-links' activeClassName='active' onClick={closeOnMobile}>
            ...
            <div className='side-nav-div'>
                <div> <p> Public</p></div>
                <NavLink to='/Questions' className='side-nav-links' onClick={closeOnMobile}>
                ...
                <NavLink to='/Tags' className='side-nav-links' activeClassName='active' onClick={closeOnMobile}>
                ...
                <NavLink to='/Saved' className='side-nav-links' activeClassName='active' onClick={closeOnMobile}>
                ...
                <NavLink to='/Users' className='side-nav-links' activeClassName='active' onClick={closeOnMobile}>
